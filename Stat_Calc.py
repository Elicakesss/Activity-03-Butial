class Stat_Calc():
    ...
    def other_stat_SPdef(pokemon_base_SPdef, pokemon_IV, pokemon_EV, pokemon_lev,pokemon_nature):
        stat_SPdef = ((((2 * pokemon_base_SPdef + pokemon_IV + (pokemon_EV/4)) * pokemon_lev)/100) + 5) * (((2 * pokemon_base_SPdef + pokemon_IV + (pokemon_EV/4)) * pokemon_lev)/100) + pokemon_nature
        return stat_SPdef
