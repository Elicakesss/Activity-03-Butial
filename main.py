...
pokemon_nature_att = 1
pokemon_nature_def = 1
pokemon_nature_SPatt = 1
pokemon_nature_SPdef = 1
...
#SPEED DEFENSE NATURE
    ...
    pokemon_nature_SPdef = 1.1
    if pokemon_nature in ['calm']:
        pokemon_nature_att = 0.9
    elif pokemon_nature_def ['hasty']:
        pokemon_nature_def = 0.9
    elif pokemon_nature in ['jolly']:
        pokemon_nature_SPatt = 0.9
    elif pokemon_nature in ['naive']:
...
if opt == 3:
    ...
    print("TOTAL BASE DEFENSE: ", sc.Stat_Calc.other_stat_def(pokemon_base_def,pokemon_IV,pokemon_lev,pokemon_nature_def), "\n")
if opt == 4:
    pokemon_base_SPAttack = int(input("Enter Base Special Attack: "))
    print_IV = int(input("Enter IV: "))
    print("TOTAL SPECIAL ATTACK: ", sc.Stat_Calc.other_stat_SPatt(pokemon_base_SPAttack,pokemon_IV,pokemon_lev,pokemon_nature_SPatt), "\n")
if opt == 5:
    pokemon_base_SPDefense = int(input("Enter Base Special Defense:"))
    print_IV = int (input("Enter IV: "))
    print("TOTAL SPECIAL DEFENSE: ",  sc.Stat_Calc.other_stat_SPdef(pokemon_base_SPDefense,pokemon_IV,pokemon_lev,pokemon_nature_SPdef), "\n")
...
if cho == 2:
    ...
    if opt == 1:
        Modifier = pokemon_nature_att
    if opt == 2:
        Modifier = pokemon_nature_def
    if opt == 3:
        Modifier = pokemon_nature_SPatt
    if opt == 4:
        Modifier = pokemon_nature_SPdef
    if opt == 5:
